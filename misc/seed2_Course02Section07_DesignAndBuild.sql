-- kermit (superuser) Thr33_Muppets (User 1)
-- mpiggy Mrf4433$1 (Miss Piggy) (User 2, Customer 1)
--  fozzy Fz44re2$1 (Fozzy Bear) (User 3, Customer 2, Staff=True)
--  rowlf Rddkf$332 (Rowlf Dog)  (User 4, Customer 3)
--    sam Frds33$ee (Sam Eagle)  (User 5, Customer 4)
...
values
	(1,r"pbkdf2_sha256$260000$C3iOoWaCNHmJUWvRfcW1DQ$vtGAX/L5GMR6whiQ6coA/Ea/sszj0EOH8pNdgM3S7jw=","2022-06-26 19:17:47.35012+00",True,"kermit","","",True,True,"2022-06-26 19:17:04.177521+00","kermit@example.com"),
	(2,r"pbkdf2_sha256$260000$C3iOoWaCNHmJUWvRfcW1DQ$vtGAX/L5GMR6whiQ6coA/Ea/sszj0EOH8pNdgM3S7jw=",NULL,False,"mpiggy","Miss","Piggy",False,True,"2022-06-26 19:20:41.180221+00","mpiggy@example.com"),
	(3,r"pbkdf2_sha256$260000$C3iOoWaCNHmJUWvRfcW1DQ$vtGAX/L5GMR6whiQ6coA/Ea/sszj0EOH8pNdgM3S7jw=",NULL,False,"fozzy","Fozzy","Bear",False,True,"2022-06-26 19:21:00.39305+00","fozzy@example.com"),
	(4,r"pbkdf2_sha256$260000$C3iOoWaCNHmJUWvRfcW1DQ$vtGAX/L5GMR6whiQ6coA/Ea/sszj0EOH8pNdgM3S7jw=",NULL,False,"rowlf","Rowlf","Dog",False,True,"2022-06-26 19:21:22.968066+00","rowlf@example.com"),
	(5,r"pbkdf2_sha256$260000$C3iOoWaCNHmJUWvRfcW1DQ$vtGAX/L5GMR6whiQ6coA/Ea/sszj0EOH8pNdgM3S7jw=",NULL,False,"sam","Sam","Eagle",False,True,"2022-06-26 19:25:10.692801+00","sam@example.com")
